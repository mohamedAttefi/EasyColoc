...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-3xl font-extrabold text-ink dark:text-slate-100 font-display">Gérer les catégories</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-1 bg-white/80 dark:bg-slate-900 rounded-2xl border border-slate-200/70 dark:border-slate-800 shadow-lg shadow-slate-200/40 p-6">
            <h2 class="text-lg font-bold text-slate-900 dark:text-slate-100 mb-4">Nouvelle catégorie</h2>
            <form method="POST" action="{{ route('categories.store') }}" class="space-y-4">
                ...
                <div>
                    <label for="icon" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Icône (Material)</label>
        ...
        <div class="lg:col-span-2 bg-white/80 dark:bg-slate-900 rounded-2xl border border-slate-200/70 dark:border-slate-800 shadow-lg shadow-slate-200/40">
            <div class="p-6 border-b border-slate-200 dark:border-slate-800">
                <h2 class="text-lg font-bold text-slate-900 dark:text-slate-100">Catégories existantes</h2>
            </div>
