...
@section('title', 'Send Invitation - EasyColoc')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/70 dark:border-slate-800 shadow-lg shadow-slate-200/40">
            <div class="p-6 border-b border-slate-200 dark:border-slate-800">
                <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100">Send Invitation</h1>
                <p class="text-slate-500 dark:text-slate-400 mt-1">Invite someone to join {{ $colocation->name }}</p>
            </div>
